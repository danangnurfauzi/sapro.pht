<!DOCTYPE html>
<html lang="en">
<head><title>Sign In | SaPro</title>
    <meta charset="utf-8">
    ...
    <form action="<?php echo site_url('auth/login/validate') ?>" class="form" method="post">
        ...
        <div class="body-content">
            ...
            <div class="form-group">
                <div class="input-icon right"><i class="fa fa-user"></i><input type="text" placeholder="NPK" name="npk" class="form-control" required></div>
            </div>
            <div class="form-group">
            ...
            <hr>
            <p>Daftar Sebagai Marketing Produk Perhutani <a id="btn-register" href="<?php echo site_url('auth/signup'); ?>">Daftar</a></p></div>
    </form>
</div>
