        ...
        <nav id="sidebar" role="navigation" data-step="2" data-intro="Template has &lt;b&gt;many navigation styles&lt;/b&gt;" data-position="right" class="navbar-default navbar-static-side">
            <div class="sidebar-collapse menu-scroll">
                <ul id="side-menu" class="nav">
                    ...
                    </i><span class="menu-title">Produk</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li><a href="<?php echo site_url('produk/kategori') ?>"><i class="fa fa-angle-right"></i><span class="submenu-title">Kategori</span></a></li>
                            <li><a href="<?php echo site_url('produk/barang') ?>"><i class="fa fa-angle-right"></i><span class="submenu-title">Barang</span></a></li>
                        </ul>
                    </li>
                    <li><a href="#"><i class="fa fa-shopping-cart">
                        <div class="icon-bg bg-green"></div>
                    </i><span class="menu-title">Order</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li><a href="<?php echo site_url('order/produk') ?>"><i class="fa fa-angle-right"></i><span class="submenu-title">Produk</span></a></li>
                            <!--li><a href="<?php echo site_url('order/pesanan') ?>"><i class="fa fa-angle-right"></i><span class="submenu-title">Pesanan</span></a></li>
                            <li><a href="<?php echo site_url('produk/kategori') ?>"><i class="fa fa-angle-right"></i><span class="submenu-title">Masuk</span></a></li>
                            <li><a href="<?php echo site_url('produk/barang') ?>"><i class="fa fa-angle-right"></i><span class="submenu-title">Validasi Pembayaran</span></a></li-->
                        </ul>
                    </li>
                    <li><a href="#"><i class="fa fa-file-text-o">
                        <div class="icon-bg bg-violet"></div>
                    </i><span class="menu-title">Invoice</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
